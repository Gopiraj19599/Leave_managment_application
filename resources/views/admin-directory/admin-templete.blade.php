...
<head>
    ...
    <title>Tealorca Leave Manegement</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('view-staff-management') }}">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Staff Management</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('view-leave-history') }}">
                    <i class="fas fa-fw fa-database"></i>
                    <span>Leave Management</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{ route('view-user-accounts') }}">
