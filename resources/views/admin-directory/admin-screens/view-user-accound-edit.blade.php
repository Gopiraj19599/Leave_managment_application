...
<div class="card">
    <div class="card-body">
      ...
      <form action="{{ route('updated-user-account') }}" method="POST">
        {{ csrf_field() }}

        <div class="form-group row">
          <label for="username" class="col-sm-2 col-form-label">Username</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" id="user_name" value="{{$user_data->user_name}}" name="user_name" placeholder="Username" required>
          </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control" id="email" value="{{$user_data->email}}" name="email" placeholder="email" readonly>
            </div>
          </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" id="password" value="{{$user_data->password}}" name="password" placeholder="Password" required>
          </div>
