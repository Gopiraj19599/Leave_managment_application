...
<div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('admin-create-staff') }}" method="POST">
          {{ csrf_field() }}
          <div class="form-row">
              ...
              <tbody>
                @foreach ($staff_data as $key => $data)
                    ...
                    <tr>
                        ...
                        <td>{{$data->position}}</td>
                        <td><a class="btn btn-primary" href="/edit-staff/{{$data->id}}">Edit</a> <a class="btn btn-danger confirmation" href="delete-staff/{{$data->id}}">Delete</a></td>
