...
@section('staff-page-content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <br>
            <div style="text-align:center;"><img style="text-align:center;" height="200px" width="200px"
            ...
            <form action="/change-username-of-staff-account" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="username" value="Gopiraj" name="username"
